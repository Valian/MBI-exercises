...
Badamy pokrycie tych odczytów ze współrzędnymi regionów sekwencjonowanych w projekcie 1000 Genomes. Mamy zadane 100 takich współrzędnych (początek i koniec). Fragment pliku \path{WES.1KG.WUGSC/extdata/chr22_400_to_500.bed}
